...
// 底部安全区域丢高度
#define kSafeBottomMargin (iPhoneXSeries ? 34.f : 0.f)
// 底部安全区域总高度
#define kSafeMarginHeight (kNavHeight + kSafeBottomMargin)
// 标签栏高度
#define kTabbarHeight (iPhoneXSeries ? (49.f + kSafeBottomMargin) : 49.f)

// 主要用来适配iPhoneX的导航栏
#define kIphoneXNavi(XValue) (iPhoneXSeries ? (XValue + 24) : (XValue))
...
// 是否为iPhone6/6S/7/7S/8
#define iPhone6 ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(750,1334), [[UIScreen mainScreen] currentMode].size) : NO)
// 是否为iPhone6*Plus/7*Plus/8*Plus
...
// 是否为iPhoneX系列
//#define iPhoneXSeries (iPhoneX || iPhoneXR || iPhoneXS || iPhoneXSMax)
...
// App的BundldId版本
#define APP_BUNDLE_ID [APP_INFO objectForKey:@"CFBundleIdentifier"]
...
// 三个屏幕尺寸对应的宽度高度 从大到小
#define kLMSScreenFit(L,M,S) ((iPhone6P||kScreenWidth>=414.0f||iPhoneXR) ? (L) : ((iPhone6||kScreenWidth>=375.0f) ? (M) : (S)))
// 建议用这个适配
...
/* --------------------------- APP bundleId -----------------------------*/
// 掌上好房通
extern NSString * const kBundleIdForErpApp;
// 开单豹
extern NSString * const kBundleIdForKdbApp;
// 友邻通(企业版/App Storen版)
extern NSString * const kBundleIdForYltApp;

#pragma mark - 定制app
// 玛雅(房口袋/玛雅好房)
extern NSString * const kBundleIdForFkdApp;
// 我有家
extern NSString * const kBundleIdForWYJApp;
// 家港在线
extern NSString * const kBundleIdForJGZXApp;
// 丰原地产
extern NSString * const kBundleIdForFYDCApp;
// 富利地产
extern NSString * const kBundleIdForFLDCApp;
